...
//function to sorted by pricing low-to-high
function lowToHigh(hotel1, hotel2) {
  return hotel1.price - hotel2.price;
}

//function to sorted by pricing high-to-low
...
function leastToMost(hotel1, hotel2) {
  return hotel1.reviews - hotel2.reviews;
}

//function to sorted by pricing most-to-least
function mostToLeast(hotel1, hotel2) {
